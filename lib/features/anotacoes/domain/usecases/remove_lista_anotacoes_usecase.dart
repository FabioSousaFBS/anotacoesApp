...
class RemoverListaAnotacoesUsecase implements Usecase<bool, AnotacoesEntity> {

  final IAnotacoesRepository repository;
  
  RemoverListaAnotacoesUsecase(this.repository);

  @override
  Future<Either<Failure, bool>> call(AnotacoesEntity params) async {
    return await repository.removerAnotacoesUsuario(params);
  }
